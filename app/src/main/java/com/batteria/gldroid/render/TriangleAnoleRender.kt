 ...
 */
class TriangleAnoleRender : GLSurfaceView.Renderer, Logger {
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        shaderProgram = GLUtils.loadProgramFromAssets("triangle_vs.glsl", "triangle_anole_fs.glsl", resources).program
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        progress += step * flag
        val colorLocation = glGetUniformLocation(shaderProgram, "anoleColor")
        glUniform4f(colorLocation, 0f, progress, 0f, 1f)
